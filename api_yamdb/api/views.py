...
class UsersViewSet(viewsets.ModelViewSet):
    ...
    def get_current_user_info(self, request):
        ...
        Если метод запроса PATCH, то проверяется,
        является ли пользователь администратором.
        Если пользователь - администратор,
        используется сериализатор UsersSerializer для
        обновления информации о текущем пользователе
        на основе полученных данных.
        В противном случае используется сериализатор
        UserNotAdminSerializer для частичного
        обновления информации о текущем пользователе
        на основе полученных данных.

        Возвращает сериализированные данные о текущем пользователе
        или код ответа HTTP 200 OK.
        """
